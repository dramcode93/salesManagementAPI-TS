...
export const createCouponValidator: express.RequestHandler[] = [
...
export const updateCouponValidator: express.RequestHandler[] = [
...
export const getCouponValidator: express.RequestHandler[] = [
    check('id').notEmpty().withMessage("coupon id is required").isMongoId().withMessage("Invalid coupon Id"),
    validatorMiddleware,
];

export const deleteCouponValidator: express.RequestHandler[] = [
    check('id').notEmpty().withMessage("coupon id is required").isMongoId().withMessage("Invalid coupon Id"),
    validatorMiddleware,
];