...
export const createBillValidator: express.RequestHandler[] = [
    check('customer')
...
export const getBillValidator: express.RequestHandler[] = [
    check('id').isMongoId().withMessage("Invalid Id"),
    validatorMiddleware,
];

export const updateBillValidator: express.RequestHandler[] = [
    check("id").isMongoId().withMessage("Invalid Id"),
...
export const deleteBillValidator: express.RequestHandler[] = [
    check('id').isMongoId().withMessage("Invalid Id"),
    validatorMiddleware,
];